...
function createBox(options = {}) {
  ...
  const Box3 = React6.forwardRef(function Box4(inProps, ref) {
...
var _excluded11 = ["cssVarPrefix", "breakpoints", "spacing", "components", "variants", "shouldSkipGeneratingVar"];
...
function extendTheme(themeOptions) {
  ...
  } = _ref, scalesInput = _objectWithoutPropertiesLoose(_ref, _excluded11);
